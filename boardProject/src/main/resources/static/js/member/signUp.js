...
const initSec  = 59; // 초기값 5분에 1초 갑소된 초

// 실제 줄어든 시간(분/초)를 저장할 변수
let min = initMin;
let sec = initSec;

let authTimer; // 타이머 역할의 setInterver을 저장할 변수
...
sendAuthKeyBtn.addEventListener("click", () => {
  ...
  // 2) 비동기로 서버에서 작성된 이메일로 인증코드 발송(AJAX) post 방식
