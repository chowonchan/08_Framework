...
public class UserController {
	...
	// 서비스 객체 DI(의존성 주입) , 생성 X ( new UserServiceImpl() 쓰지 않아도 됨)
	@Autowired
	...
	public String userSelect(
		...
		ra.addFlashAttribute("message", "사용자가 존재 하지 않습니다");
		
		// redirect : req,resp 재요청으로 기존 사라짐 model 도 기본 req라 사용 불가
	...
	/** 
	 * @param userNo : 주소에서 {userNo} 자리의 얻값을 얻어와 저장한 변수
